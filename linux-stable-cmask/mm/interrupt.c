...
unsigned int __NR_cache_insert 250
...
//   mark_bh(IMMEDIATE_BH);
	...
	printk("iqr_handler: cmask_insert_SPP_to_IAL is called.\n"); // return 0;
	return ret;
}

//SYSCALL_DEFINE1(cmask_insert_SPP_to_IAL, sector_t, sector)
//{
//	long ret = 1;
//
//	printk("sys_cmask_insert_SPP_to_IAL : sys_cmask_insert_SPP_to_IAL is called.\n"); // return 0;
//	return ret;
//}
...
//   free_irq(1, NULL);
    ...
    */
   return request_irq(__NR_cache_insert,   /* The number of the keyboard IRQ on PCs */
              irq_handler, /* our handler */
              SA_SHIRQ,
              "insert SPP to indirect access location in cache", NULL);
}
...
void cleanup_module()
{
    ...
    */
   free_irq(__NR_cache_insert, NULL);
}
